...
function BlogComponent() {
  const renderHeader = () => (
    <div className='h-72 w-full relative -z-10'>
      ...
      <h1 className='text-5xl lg:text-7xl  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-serif text-white absolute'>Blog</h1>
    </div>
  )
  ...
  const renderContent = () => (
    <div className='xl:px-80 md:px-16 px-8 py-10 font-serif'>
      <p className='my-5'>
