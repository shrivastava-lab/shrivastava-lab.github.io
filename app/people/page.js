...
function PeopleComponent() {
  ...
  const renderStudentData = (studentType = 'Postdoctoral Fellows') => (
    <div className='mt-10'>
      ...
      <div className='flex flex-col lg:flex-row items-base justify-normal flex-wrap'>
        {content.students[studentType].map((student, index) => (
          <section key={index} className='basis-1/3 py-5 lg:p-5'>
  ...
  const renderContent = () => (
    <div className='lg:px-80 px-8 py-10 font-serif text-center '>
      <div className='flex flex-col lg:flex-row items-center justify-between'>
        ...
        <section className='basis-2/3'>
          <div className='px-4 mt-4 lg:px-12'>
